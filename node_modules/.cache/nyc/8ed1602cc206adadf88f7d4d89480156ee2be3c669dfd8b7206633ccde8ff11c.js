...
function handelError(req, res,next){
  ...
  if (req.body === undefined || req.body === null)  
  {
    if (req.app.locals.t["ERRORS"] !== undefined && req.app.locals.t["ERRORS"]["EMPTY_PUBLICATION_FORM"] !== undefined)
    {
      ...
      that.list.push(req.app.locals.t["ERRORS"]["EMPTY_PUBLICATION_FORM"])
    }
  }
...

  {
    ...
    if ( req.body.year === undefined || isNaN(req.body.year) || req.body.year<0)
      {
    ...
    if (req.body.month === undefined || isNaN(req.body.month) || req.body.month<0 || req.body.month>11)
    ...
    if ( req.body.title === undefined || (req.body.title).length < 5)
    ...
    if ( req.body.venue === undefined || (req.body.venue).length < 5)
