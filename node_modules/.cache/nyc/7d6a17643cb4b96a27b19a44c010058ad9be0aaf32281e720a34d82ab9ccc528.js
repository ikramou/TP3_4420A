 ...
 */cov_2ghiihksz.s[2]++;const getProjects=db=>{cov_2ghiihksz.f[0]++;cov_2ghiihksz.s[3]++;return language=>{cov_2ghiihksz.f[1]++;cov_2ghiihksz.s[4]++;return callback=>{cov_2ghiihksz.f[2]++;cov_2ghiihksz.s[5]++;// À COMPLÉTER
callback(null,[]);};};};/**
 ...
 */cov_2ghiihksz.s[6]++;const getProjectById=db=>{cov_2ghiihksz.f[3]++;cov_2ghiihksz.s[7]++;return translationObj=>{cov_2ghiihksz.f[4]++;cov_2ghiihksz.s[8]++;return language=>{cov_2ghiihksz.f[5]++;cov_2ghiihksz.s[9]++;return id=>{cov_2ghiihksz.f[6]++;cov_2ghiihksz.s[10]++;return callback=>{cov_2ghiihksz.f[7]++;cov_2ghiihksz.s[11]++;// À COMPLÉTER
callback();};};};};};cov_2ghiihksz.s[12]++;module.exports=db=>{cov_2ghiihksz.f[8]++;cov_2ghiihksz.s[13]++;return{getProjects:getProjects(db),getProjectById:getProjectById(db)};};